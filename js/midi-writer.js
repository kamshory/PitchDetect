var MidiWriter = (function () {
      ...
      if (match) {
        ...
        if (isValidBase) {
          ...
          if (dotted) {
            ...
            durationInQuarters =
              durationInQuarters +
              durationInQuarters * ((divisor - 1) / divisor);
          }
  ...
  var EndTrackEvent = /** @class */ (function () {
    function EndTrackEvent(fields) {
      this.delta =
        (fields === null || fields === void 0 ? void 0 : fields.delta) || 0x00;
  ...
  var NoteOnEvent = /** @class */ (function () {
     ...
     * @return {NoteOnEvent}
     */
    NoteOnEvent.prototype.buildData = function (
      track,
      precisionDelta,
      options
    ) {
      ...
      this.deltaWithPrecisionCorrection = Utils.getRoundedIfClose(
        this.delta - precisionDelta
      );
      this.data = Utils.numberToVariableLength(
        this.deltaWithPrecisionCorrection
      ).concat(
  ...
  var NoteOffEvent = /** @class */ (function () {
     ...
     * @return {NoteOffEvent}
     */
    NoteOffEvent.prototype.buildData = function (
      track,
      precisionDelta,
      options
    ) {
          ...
          this.pitch.forEach(function (p, i) {
            ...
            if (i == 0) {
              ...
              noteOffNew = new NoteOffEvent({
                ...
                tick:
                  _this.tick !== null
                    ? Utils.getTickDuration(_this.duration) + _this.tick
                    : null,
              });
            } else {
  ...
  var Track = /** @class */ (function () {
    ...
    Track.prototype.buildData = function (options) {
      ...
      this.events.forEach(function (event) {
        ...
        if (event instanceof NoteOnEvent || event instanceof NoteOffEvent) {
          ...
          precisionLoss = Utils.getPrecisionLoss(
            event.deltaWithPrecisionCorrection || 0
          );
      ...
      if (
        !this.events.length ||
        !(this.events[this.events.length - 1] instanceof EndTrackEvent)
      ) {
     ...
     * @return {Track}
     */
    Track.prototype.setTimeSignature = function (
      numerator,
      denominator,
      midiclockspertick,
      notespermidiclock
  ...
  var VexFlow = /** @class */ (function () {
          ...
          track.addEvent(
            new NoteEvent({
              pitch: tickable.keys.map(function (pitch, index) {
                return _this.convertPitch(
                  pitch,
                  index,
                  tickable,
                  options.addRenderedAccidentals
                );
              }),
     ...
     */
    VexFlow.prototype.convertPitch = function (
      pitch,
      index,
      note,
      addRenderedAccidentals
    ) {
      var _a;
      ...
      if (addRenderedAccidentals) {
        (_a = note.getAccidentals()) === null || _a === void 0
          ? void 0
          : _a.forEach(function (accidental) {
    ...
    VexFlow.prototype.convertDuration = function (note) {
      return (
        "d".repeat(note.dots) +
        this.convertBaseDuration(note.duration) +
        (note.tuplet ? "t" + note.tuplet.num_notes : "")
      );
    };
    /**
